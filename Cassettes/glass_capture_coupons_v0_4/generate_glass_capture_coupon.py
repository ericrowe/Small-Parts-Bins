...
def write_preview(path: Path) -> None:
    path.write_text('''<svg xmlns="http://www.w3.org/2000/svg" width="860" height="360" viewBox="0 0 860 360">
<rect width="100%" height="100%" fill="#f7f4ed"/><text x="28" y="34" font-family="sans-serif" font-size="20" font-weight="bold">Plan 009 short PETG latch coupon v0.4</text>
<g transform="translate(55 85)"><rect x="0" y="0" width="310" height="200" fill="#d8d1c2" stroke="#222" stroke-width="2"/><rect x="40" y="0" width="230" height="200" fill="#9ed5e5" stroke="#174c5b"/><rect x="115" y="75" width="80" height="68" fill="#e7a84f" stroke="#6d4610"/><rect x="95" y="68" width="120" height="30" fill="#e7a84f" stroke="#6d4610"/><rect x="115" y="78" width="80" height="18" fill="#b04b3f"/><rect x="0" y="143" width="310" height="19" fill="#c5bdac" stroke="#222"/><text x="75" y="235" font-family="sans-serif" font-size="14">6.75 mm straight free length</text></g>
<g transform="translate(420 90)" font-family="sans-serif"><text x="0" y="0" font-size="16" font-weight="bold">Only change from passing v0.3</text><text x="0" y="31" font-size="14">27.0 mm tongue → 6.75 mm tongue</text><text x="0" y="70" font-size="16" font-weight="bold">Unchanged</text><text x="0" y="99" font-size="14">27.0 mm loading channel</text><text x="0" y="124" font-size="14">23.0 / 24.0 mm capture openings</text><text x="0" y="149" font-size="14">1.4 mm clear channel height</text><text x="0" y="174" font-size="14">0.6 mm latch thickness</text><text x="0" y="214" font-size="14" font-weight="bold">Material: PETG only</text><text x="0" y="247" font-size="13" fill="#9b2020">Depress manually; do not cam with glass.</text></g></svg>''')

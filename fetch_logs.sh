#!/usr/bin/env bash
# ==============================================================================
# fetch_logs.sh - Error Log Harvester for Parts-Database
# Retrieves systemd service journals and catalog error logs from Node 02 (tasker-pi)
# ==============================================================================
set -euo pipefail
...
echo "======================================================================"
echo "📋 Fetching Parts-Database Logs (Node 02: $PI_HOST | Last $LINES lines)"
echo "======================================================================"
...
LOCAL_FOUND=0
for log_file in "$SCRIPT_DIR/server/logs/backup.log" "$SCRIPT_DIR/server/logs/error.log"; do
